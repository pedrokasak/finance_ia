...
export function FinancialMethodModal({
  open,
  onOpenChange,
  currentMethodId,
  onSelect,
}: FinancialMethodModalProps) {
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Escolha ou altere a estratégia que usaremos para classificar seu
              orçamento mensal.
            </DialogDescription>
          </DialogHeader>
      ...
      {detailMethod && (
        <Dialog
          open={!!detailMethod}
          onOpenChange={() => setDetailMethod(null)}
        >
